...
import seminar2.simple_shopping_cart.Cart;
import seminar2.simple_shopping_cart.Product;
import seminar2.simple_shopping_cart.Shop;
...
*/
     ...
     */
    @ParameterizedTest
    @ValueSource(ints = { 20, 14, 15 })
    void incorrectProductSelectionCausesException(int ids) {

        String expectedMessage2 = "Не найден продукт с id: " + ids;
        // Act
        RuntimeException exception = assertThrows(RuntimeException.class, () -> {
            cart.addProductToCartByID(ids);
        });
        // Assert
        assertEquals(expectedMessage2, exception.getMessage());
